                ...
                <div style={{border: "0px solid blue"}} className="btn-group mt-3" role="group">
                    ...
                    <div>
                        <button onClick={this.delete} className="btn btn-danger"
                                style={{'border': "0px solid yellow", 'margin-left': '10px'}}>
                            Delete workspace
                        </button>
                    </div>
                    }
                        ...
                        <table style={{border: "0px solid yellow"}} className="table table-hover">
                            ...
                            {users.map(function (user, key) {
                                return (
                                    <tr key={key}>
                                        <td scope="col">
                                            <img src={user.image_link} alt='' width="30" height="30"
                                                 className='rounded-1'/>
                                        </td>
                                        ...
                                        <td scope="col">
                                            ...
                                            {
                                                localStorage.getItem('is_admin') != 'true' && <p>No action available</p>
                                            }
                                        </td>
                                    </tr>
                                );
